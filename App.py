...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_search.setToolTip("<html><head/><body><p>Digite algo no campo de pesquisa ao lado para fazer uma busca por um ID correspondente</p></body></html>")
        ...
        self.txt_search.setPlaceholderText("Digite algo para pesquisar seu ID")
